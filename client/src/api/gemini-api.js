...
export class GeminiAPI {
    ...
    connect() {
        ...
        this.onStateAgentUpdate = () => {};  // New callback for StateAgent updates
    ...
    setupWebSocket() {
        ...
        this.ws.onmessage = async (event) => {
            try {
                ...
                } else if (response.type === 'state_agent_update') {
                    console.log('Received StateAgent update:', response);
                    this.onStateAgentUpdate(response);
                } else {
